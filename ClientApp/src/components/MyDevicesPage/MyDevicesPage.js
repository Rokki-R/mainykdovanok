  ...
  return (
    <Container className="home-user-devices">
      {loading ? (
        ...
        <>
          {devices.length > 0 && (
            <h3 style={{ textAlign: 'center', marginBottom: '10px' }}>Jūsų dovanojami skelbimai</h3>
          )}
          {devices.length === 0 ? (
            <h3 style={{ textAlign: 'center', marginBottom: '10px' }}>Jūs neturite nei vieno aktyvaus skelbimo</h3>
          ) : (
